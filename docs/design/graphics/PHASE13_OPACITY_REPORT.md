...
`include/display.h`, `kernel/gfx/compositor.c`, `kernel/gfx/kwm.c`, `kernel/display.c`, `libs/core/libgui.c`, `libs/gui/widget/` (dulu `apps/libui.cpp`), `libs/media/png.c`, `rust/kyuzen-gui/src/lib.rs`, `kernel/mm/heap.c`, `graphics/backend/software.c`, `include/aa_math.h`
