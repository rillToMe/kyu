...
graphics/backend/*), VirtIO-GPU driver, libs/core/libgui.c, libs/gui/widget/ (dulu apps/libui.cpp),
libs/media/png.c, Slint renderer internals, KWM event routing, scheduler, heap,
