...
#
# Memakai harness test/_ui_probe.py (boot -> login root/1 -> `start fileman`)
# lalu memeriksa DUA jenis bukti:
#
#   1. LAYAR (screendump PPM): geometri + warna. Teks toolkit digambar
#      anti-aliased oleh compositor sehingga test/_screen_text.py (font 8x16
...
#      user_apps/filemanager/app.cpp) untuk setiap operasi yang MENGUBAH filesystem —
...
#
#   python test/_fileman_probe.py [langkah...]
...
OUT = os.path.join(P.ROOT, "test", "_ui_out")
