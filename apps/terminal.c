// apps/terminal.c — Terminal (Phase 10): console window (libui).
//
// FRONTEND saja. Semua perintah/parsing/identitas dimiliki shell engine
// bersama (system/shell_core.c, API di include/shell.h). Terminal hanya:
...
void main(void) {
    ...
    // Warna per komponen lewat libs/gui/color (bukan hex 0xAARRGGBB lagi).
    ui_theme_t theme;
