// user_apps/filemanager/platform.hpp — satu-satunya tempat app ini menyentuh header
// platform C.
//
...
// (user_apps/gallery/platform.hpp), toolkit (libs/widget/include/runtime) dan
...
#include "media.h"         // tipe berkas + util path + format ukuran (apps/media.c)
