// libs/media/media.c — abstraksi media bersama user-space (lihat include/media.h).
//
// Library bersama pola libs/media/png.c: dikompilasi SEKALI (-O2) dan di-link oleh
...
// ada alokasi dinamis selain yang dipakai lewat image_decode() (libs/media/png.c).
//
...
// libc (memcpy/memset weak dari libs/core/userlib.c tetap dipakai, disediakan
