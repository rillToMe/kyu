// ============================================================
// KERNEL USERLIB SHIM — libs/core/kernel_userlib.c
//
// Implementasi kernel-side dari fungsi-fungsi yang dipanggil
// oleh system/shell.c, system/zen.c, dan system/login.c.
//
...
// Shell engine (system/shell_core.c) memakai subset API generik ini; sediakan
