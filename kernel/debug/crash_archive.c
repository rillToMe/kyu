// kernel/debug/crash_archive.c — crashdump → berkas di FS (lihat include/crash_archive.h)
//
// Alur lengkap fitur crash safety:
//   1. Panic        : kernel/debug/crashdump.c menulis snapshot 4KB ke 8 sektor ekor
//                     disk (polling ATA, tanpa lock) + kernel/debug/panic_log.c
